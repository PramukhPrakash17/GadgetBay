 ...
 */
package com.pramukh.shoppingapplication.orderservice.event;
...
public class OrderPlacedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1797207145698132055L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderPlacedEvent\",\"namespace\":\"com.pramukh.shoppingapplication.orderservice.event\",\"fields\":[{\"name\":\"orderNumber\",\"type\":\"string\"},{\"name\":\"email\",\"type\":\"string\"},{\"name\":\"name\",\"type\":\"string\"}]}");
   ...
   */
  public OrderPlacedEvent(java.lang.CharSequence orderNumber, java.lang.CharSequence email, java.lang.CharSequence name) {
   ...
   */
  public static com.pramukh.shoppingapplication.orderservice.event.OrderPlacedEvent.Builder newBuilder() {
    return new com.pramukh.shoppingapplication.orderservice.event.OrderPlacedEvent.Builder();
  }
   ...
   * @return A new OrderPlacedEvent RecordBuilder
   */
  public static com.pramukh.shoppingapplication.orderservice.event.OrderPlacedEvent.Builder newBuilder(com.pramukh.shoppingapplication.orderservice.event.OrderPlacedEvent.Builder other) {
    if (other == null) {
      return new com.pramukh.shoppingapplication.orderservice.event.OrderPlacedEvent.Builder();
    } else {
      return new com.pramukh.shoppingapplication.orderservice.event.OrderPlacedEvent.Builder(other);
    }
  }
   ...
   * @return A new OrderPlacedEvent RecordBuilder
   */
  public static com.pramukh.shoppingapplication.orderservice.event.OrderPlacedEvent.Builder newBuilder(com.pramukh.shoppingapplication.orderservice.event.OrderPlacedEvent other) {
    if (other == null) {
      return new com.pramukh.shoppingapplication.orderservice.event.OrderPlacedEvent.Builder();
    } else {
      return new com.pramukh.shoppingapplication.orderservice.event.OrderPlacedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderPlacedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.pramukh.shoppingapplication.orderservice.event.OrderPlacedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.pramukh.shoppingapplication.orderservice.event.OrderPlacedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.orderNumber)) {
        this.orderNumber = data().deepCopy(fields()[0].schema(), other.orderNumber);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pramukh.shoppingapplication.orderservice.event.OrderPlacedEvent.Builder setOrderNumber(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pramukh.shoppingapplication.orderservice.event.OrderPlacedEvent.Builder clearOrderNumber() {
      orderNumber = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pramukh.shoppingapplication.orderservice.event.OrderPlacedEvent.Builder setEmail(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pramukh.shoppingapplication.orderservice.event.OrderPlacedEvent.Builder clearEmail() {
      email = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pramukh.shoppingapplication.orderservice.event.OrderPlacedEvent.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pramukh.shoppingapplication.orderservice.event.OrderPlacedEvent.Builder clearName() {
      name = null;
